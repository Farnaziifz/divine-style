...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'search.prompt': 'Type something to search our products',
    ...
    'product.select_color_hint': 'You will receive the exact color you select here',
    'product.select_color_required': 'Please select a color',
  ...
  fa: {
    ...
    'nav.search': 'جستجو',
    'search.title': 'جستجوی محصولات',
    'search.placeholder': 'نام محصول را جستجو کنید...',
    'search.submit': 'جستجو',
    'search.prompt': 'برای جستجو در محصولات، عبارتی را تایپ کنید',
    'search.noResults': 'محصولی مطابق جستجوی شما یافت نشد',
    'search.resultsCount': '{count} نتیجه',
    'catalog.title': 'همه محصولات',
    'catalog.allCategories': 'همه',
    'catalog.viewAll': 'مشاهده همه محصولات',
    'common.back': 'بازگشت',
    'common.close': 'بستن',
    'common.prev': 'قبلی',
    'common.next': 'بعدی',
    ...
    'product.select_color_hint': 'رنگ محصول ارسالی همین رنگ انتخابی شما خواهد بود',
    'product.select_color_required': 'لطفاً رنگ مورد نظر را انتخاب کنید',
